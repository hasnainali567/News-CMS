...
router.post('/login', isValid.loginValidation, LoginAdmin);
...
router.post('/add-user', adminMiddleware, isValid.userValidation, addUser);
router.get('/update-user/:id', adminMiddleware, updateUserPage);
router.post('/update-user/:id', adminMiddleware, isValid.userUpdateValidation, updateUser);
